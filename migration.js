...
db.serialize(() => {
  ...
  */
  ...
  db.run('CREATE TABLE IF NOT EXISTS Issue(id INTEGER PRIMARY KEY, name TEXT REQUIRED, issue_number TEXT REQUIRED, publication_date TEXT REQUIRED, artist_id INTEGER FOREIGN KEY REQUIRED, series_id INTEGER FOREIGN KEY REQUIRED)');
});
